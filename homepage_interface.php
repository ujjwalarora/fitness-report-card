...
<img src="generate_reportcard_image.php?uid='.$uid.'&name='.$name.'&gender='.$gender.'&birthday='.$birthday.'&age_category='.$age_category.'" height=530px width=447px />
</div>
...
<a href="http://www.facebook.com/ujjwalarora92" target="_blank"><div style="margin-top:400px; margin-left:40px; display: inline-block; outline: none; cursor: pointer; text-align: center; text-decoration: none; font: bold 14px/100% Arial,Helvetica,sans-serif; padding: 6px 17px; text-shadow: 0 1px 1px #333; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; -webkit-box-shadow: 0 1px 2px #333; -moz-box-shadow: 0 1px 2px #333; box-shadow: 0 1px 2px #333; color: #fff; border: solid 1px #0085CF; background: -moz-linear-gradient(top,  #48B9FD,  #0090DF); progid: DXImageTransform.Microsoft.gradient(startColorstr=#48B9FD, endColorstr=#0090DF);">App developed by : Ujjwal Arora</div></a>
